...
namespace EPYTST.API.Contollers.ReportAPI
{
    ...
    public class ReportAPIController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ReportAPISetup), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> GetGenericReport(string username, string token, string reportName, string values,string localIP)
        {
            var lst = await _setupService.GetDynamicReportAPIDataAsync(username, token, reportName, values, localIP);
